...
// Outputs are TIMESTAMPED migrations (applied via `supabase db push`) so they
// never collide with life-assistant's 000N-numbered migrations in the shared
// project's migration history. See ../../CLAUDE.md.
const HERE = dirname(fileURLToPath(import.meta.url));
const MIGR = join(HERE, '..', 'migrations');
const OUT = join(MIGR, '20260619120100_tarot_seed_reference.sql');
const OUT_INTERP = join(MIGR, '20260619120200_tarot_seed_interpretations.sql');
...
let isql = `-- 20260619120200_tarot_seed_interpretations.sql — GENERATED by supabase/seed/build-seed.mjs.
